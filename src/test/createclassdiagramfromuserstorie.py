...
def userstories_to_classdiagram(userstories_json: str) -> str:
    userstories = json.loads(userstories_json)
...
if __name__ == "__main__":
    with open("userstories.json", "r", encoding="utf-8") as f:
        userstories_data = f.read()

    result = userstories_to_classdiagram(userstories_data)
    print(result)
